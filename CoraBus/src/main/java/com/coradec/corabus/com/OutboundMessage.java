...
/**
 * ​A message encapsulating a message to be sent through the network client.
 */
public interface OutboundMessage extends Message {
     ...
     */
    SessionMessage getContent();

    /**
     * Path to the real recipient inside the corabus network.
     *
     * @return the real recipient.
     */
    Path getPath();
