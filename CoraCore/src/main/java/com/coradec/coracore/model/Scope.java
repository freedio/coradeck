...
/**
 * ​Enumeration of implementation scopes.
 */
public enum Scope {
    /** The same instance will always be reused. */
    SINGLETON,
    /** Each time, a new instance is generated. */
    TEMPLATE,
    /** The same instance will only be returned if the parametrized type arguments match. */
    PARAMETRIZED,
    /** The same instance will be reused if the supplied constructor arguments are identical. */
    IDEMPOTENT
}
