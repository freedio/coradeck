...
/**
 * ​​Indicates an attempt to parse beyond the available data.
 */
public class UnexpectedEndOfDataException extends BasicException {

    private final String data;

    public UnexpectedEndOfDataException(final String data) {
        this.data = data;
    }

    @ToString public String getData() {
        return this.data;
    }
}
