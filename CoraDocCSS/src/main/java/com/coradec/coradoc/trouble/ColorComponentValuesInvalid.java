...
/**
 * ​​Indicates an invalid number of color components.
 */
public class ColorComponentValuesInvalid extends CssSyntaxException {

    private final List<ParserToken> componentValues;

    public ColorComponentValuesInvalid(final List<ParserToken> componentValues) {
